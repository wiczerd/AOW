...
plt.plot(wgrid, Fw, 'k', wgridBM, FBM, 'b:o', linewidth=2)
...
plt.figure(facecolor="white")
plt.plot(zgrid,Rz/wbar,'k',np.linspace(z0,zZ,zpts),ERz*np.ones(zpts),'k--',
...
plt.figure(facecolor="white")
plt.plot(Gw,Fw,'r-',Gw,FGz[:,0],'k*',Gw,FGz[:,zpts-1],'ko',Gw,Gtilde,'b--',linewidth=2)
plt.xlabel('Wage quantile')
plt.ylabel('Cumulative distribution')
